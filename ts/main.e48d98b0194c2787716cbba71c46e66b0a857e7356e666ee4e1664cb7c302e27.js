(() => {
  ...
  var GLYPHS = {
    ...
    greenExpand: '<svg class="glyph-expand" viewBox="0 0 16 16" width="16" height="16"><path d="M4 4 H9 L4 9 Z M12 12 H7 L12 7 Z" fill="rgba(0,0,0,0.62)"/></svg>',
    greenContract: '<svg class="glyph-contract" viewBox="0 0 16 16" width="16" height="16"><path d="M4 9 L9 4 V9 Z M12 7 L7 12 V7 Z" fill="rgba(0,0,0,0.62)"/></svg>'
  };
