(() => {
  ...
  var GLYPHS = {
    ...
    greenExpand: '<svg class="glyph-expand" viewBox="0 0 16 16" width="16" height="16"><path d="M5 5 H9 L5 9 Z M11 11 H7 L11 7 Z" fill="rgba(0,0,0,0.62)"/></svg>',
    greenContract: '<svg class="glyph-contract" viewBox="0 0 16 16" width="16" height="16"><path d="M5 8 L8 5 V8 Z M11 8 L8 11 V8 Z" fill="rgba(0,0,0,0.62)"/></svg>'
  };
