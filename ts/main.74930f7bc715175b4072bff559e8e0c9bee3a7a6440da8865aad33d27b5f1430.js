(() => {
  ...
  var GLYPHS = {
    ...
    // macOS 全屏图标为对角双角：默认肘部朝外（右上+左下，展开）；
    // 已展开时换成肘部朝内的反向双角（收缩）
    greenExpand: '<svg class="glyph-expand" viewBox="0 0 16 16" width="16" height="16"><path d="M8.5 3.5 H12.5 V7.5 M7.5 12.5 H3.5 V8.5" stroke="rgba(0,0,0,0.6)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
    greenContract: '<svg class="glyph-contract" viewBox="0 0 16 16" width="16" height="16"><path d="M12.5 7.5 H8.5 V3.5 M3.5 8.5 H7.5 V12.5" stroke="rgba(0,0,0,0.6)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>'
  };
