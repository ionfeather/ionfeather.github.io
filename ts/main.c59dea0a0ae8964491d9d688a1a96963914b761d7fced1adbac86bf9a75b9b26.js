(() => {
  ...
  var GLYPHS = {
    ...
    // 已展开时换成肘部朝内的反向双角（收缩）
    greenExpand: '<svg class="glyph-expand" viewBox="0 0 16 16" width="16" height="16"><path d="M8 3.5 H3.5 V8 M8 12.5 H12.5 V8" stroke="rgba(0,0,0,0.62)" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
    greenContract: '<svg class="glyph-contract" viewBox="0 0 16 16" width="16" height="16"><path d="M4 6.5 H6.5 V4 M12 9.5 H9.5 V12" stroke="rgba(0,0,0,0.62)" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>'
  };
