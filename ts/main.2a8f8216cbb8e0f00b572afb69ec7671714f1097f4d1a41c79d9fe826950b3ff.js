(() => {
  ...
  var GLYPHS = {
    ...
    green: '<svg viewBox="0 0 16 16" width="16" height="16"><path d="M6.5 4.5 H4.5 V6.5 M9.5 4.5 H11.5 V6.5 M11.5 9.5 V11.5 H9.5 M6.5 11.5 H4.5 V9.5" stroke="rgba(0,0,0,0.6)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>'
  };
  function setupCodeHeader() {
    ...
    highlights.forEach((highlight) => {
      ...
      const dots = [
        ...
        { cls: "code-dot-green", title: "\u5168\u5C4F\u663E\u793A", state: "code-maximized", glyph: GLYPHS.green }
      ];
