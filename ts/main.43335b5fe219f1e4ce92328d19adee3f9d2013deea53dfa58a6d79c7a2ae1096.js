(() => {
  ...
  var GLYPHS = {
    ...
    // 展开态：四角括号肘部朝外（展开）；已展开时换成肘部朝内的反向括号（收缩）
    greenExpand: '<svg class="glyph-expand" viewBox="0 0 16 16" width="16" height="16"><path d="M6.5 4.5 H4.5 V6.5 M9.5 4.5 H11.5 V6.5 M11.5 9.5 V11.5 H9.5 M6.5 11.5 H4.5 V9.5" stroke="rgba(0,0,0,0.6)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
    greenContract: '<svg class="glyph-contract" viewBox="0 0 16 16" width="16" height="16"><path d="M4.5 6.5 H6.5 V4.5 M11.5 6.5 H9.5 V4.5 M11.5 9.5 H9.5 V11.5 M4.5 9.5 H6.5 V11.5" stroke="rgba(0,0,0,0.6)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>'
  };
  function setupCodeHeader() {
    ...
    highlights.forEach((highlight) => {
      ...
      const dots = [
        ...
        { cls: "code-dot-green", title: "\u5B8C\u6574\u5C55\u5F00", state: "code-expanded", glyph: GLYPHS.green }
      ];
