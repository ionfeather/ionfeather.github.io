(() => {
  ...
  var GLYPHS = {
    ...
    // macOS 全屏图标为对角双角：默认肘部朝外（左上+右下，展开）；
    // 已展开时换成肘部朝内的反向双角（收缩）
    greenExpand: '<svg class="glyph-expand" viewBox="0 0 16 16" width="16" height="16"><path d="M9.5 3.5 H3.5 V9.5 M6.5 12.5 H12.5 V6.5" stroke="rgba(0,0,0,0.62)" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
    greenContract: '<svg class="glyph-contract" viewBox="0 0 16 16" width="16" height="16"><path d="M3.5 6.5 H6.5 V3.5 M12.5 9.5 H9.5 V12.5" stroke="rgba(0,0,0,0.62)" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>'
  };
